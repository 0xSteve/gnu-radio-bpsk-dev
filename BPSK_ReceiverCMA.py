...
# Title: Bpsk Receivercma
# Generated: Tue Jun  7 23:37:34 2016
##################################################
...
class BPSK_ReceiverCMA(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Bpsk Receivercma")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Bpsk Receivercma")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_ReceiverCMA")
        ...
        self.interpolation = interpolation = 96000 #change this one!!
        ...
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(15, 1, eq_gain, 1)
...
def main(top_block_cls=BPSK_ReceiverCMA, options=None):
